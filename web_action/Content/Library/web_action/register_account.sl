...
operation:
  ...
  sequential_action:
    ...
    steps:
      ...
      - step:
          id: '16'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").Link("My account")'
          action: Click
          snapshot: ".\\Snapshots\\ssf15.html"
          highlight_id: '10000000'
      - step:
          id: '17'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Voornaam Achternaam")'
          action: Output
          default_args: 'CheckPoint("Full_Name")'
      - step:
          id: '18'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").Link("UserMenu_2")'
          action: Click
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[1]/DIV[1]/DIV[1]/LABEL[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: '01 March 2023 16:06:19'
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: Gebruikersnaam My account My orders Sign out
                            regular_expression: false
                          name: text
                          hidden: false
                          read_only: false
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="loginMiniTitle"]/LABEL[@role="link" and normalize-space()="My account"]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
