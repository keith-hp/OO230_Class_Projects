...
operation:
  ...
  inputs:
    ...
    - email
  sequential_action:
    gav: 'com.microfocus.seq:web_action.register_account_act:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          ...
          highlight_id: '2294364'
      - step:
          id: '16'
          object_path: "'Browser(\"Advantage Shopping\").Page(\"Advantage Shopping\").WebElement(\"Robbert\")"
          action: Output
          default_args: 'CheckPoint("Logged_in_user")'
  outputs:
    - Logged_in_user:
        robot: true
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: '01 March 2023 14:31:20'
